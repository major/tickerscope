...
_PARSE_DATE_DT_CASES = [
    ...
    (Pattern, _PATTERN_KWARGS, "base_bottom_date", "2023-02-24"),
    (Pattern, _PATTERN_KWARGS, "base_bottom_date", None),
    (Pattern, _PATTERN_KWARGS, "left_side_high_date", "2023-02-07"),
    (Pattern, _PATTERN_KWARGS, "left_side_high_date", None),
    (Pattern, _PATTERN_KWARGS, "pivot_price_date", "2023-03-22"),
    (Pattern, _PATTERN_KWARGS, "pivot_price_date", None),
